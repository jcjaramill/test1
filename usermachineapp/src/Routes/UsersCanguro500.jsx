        ...
        if (JSON.parse(localStorage.getItem("currentUser"))) {
            ...
            const Get_UsersEnvases = async()=>{
                await fetch(`${URL_API}/usersByPlantSolidosFETTE`, {
                    ...
                    body: JSON.stringify({planta:'Solidos', equipo: 'Canguro 500', area: 'Preparación'})
                })
                .then(res=>res.json())
                .then(data=>{
                    console.log(data)
                    ...
                    const getExcel = async()=>{
                      //alert(currentUser_Token)
                        const arrayData = {equipo: 'Canguro 500', area: 'Preparación', planta: "Solidos"}
                        const headers = {
                          'Authorization': currentUser_Token,
    ...
    return(
        <div className="container">
            ...
            <ToastContainer/>
              ...
              <h4 >Usuarios mezclador Canguro 500</h4>
